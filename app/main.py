...
async def main() -> None:
    ...
    # Wake up program:
    # 1. First turn on devices in parallel
    # 2. Then play song (must happen after speaker is on)
    await run_sequence(
        run_parallel(
    ...
    # Sleep program:
    # 1. Turn off hue light and speaker in parallel
    # 2. Then flush and clean toilet in sequence
    await run_sequence(
        run_parallel(
